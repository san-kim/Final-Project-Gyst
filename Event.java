...
public class Event {
    ...
    public Event(long id, String name, String start, String end, String note, String loc, Account h, boolean all){
        ...
        interested = new ArrayList<Account>();
        going = new ArrayList<Account>();
        not_going = new ArrayList<Account>();
        no_response = new ArrayList<Account>();
        people_shared = new ArrayList<Account>();
        
        //ADDED
        people_shared.add(h);
        
        DatabaseAccess da = new DatabaseAccess();
        //add event for all of people_shared
        da.addEventsForMultipleUsers(this);
    }
